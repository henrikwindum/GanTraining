...
# We implement the following discriminator based on the code provided in https://github.com/microsoft/StyleSwin/tree/main/models.
class ConvLayer(nn.Sequential):
    def __init__(self, in_channel, out_channel, kernel_size, downsample=False, blur_kernel=[1, 3, 3, 1], bias=True, activate=True, sn=False):
        layers = []
...
class Discriminator(nn.Module):
    ...
    def forward(self, input):
        ...
        stddev = stddev.mean([2, 3, 4], keepdims=True).squeeze(1)
